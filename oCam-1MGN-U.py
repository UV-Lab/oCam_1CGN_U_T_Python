...
devpath = liboCams.FindCamera('oCam-1MGN-U')
...
test.SetControl(ctrlist[b'Brightness'], 60)
...
if True:
  ...
  while True:
    ...
    if char == 27:
      ...
      if char == ord('i'):
        val = test.GetControl(ctrlist[b'Brightness'])
        test.SetControl(ctrlist[b'Brightness'],val+1)
      elif char == ord('k'):
        val = test.GetControl(ctrlist['Brightness'])
        test.SetControl(ctrlist[b'Brightness'],val-1)
      elif char == ord('l'):
